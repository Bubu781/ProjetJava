...
CREATE TABLE Trimestre(Id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, Numero int NOT NULL, Debut DATE NOT NULL, Fin DATE NOT NULL,annee_scolaire int NOT NULL, FOREIGN KEY(annee_scolaire) REFERENCES AnneeScolaire(Id));
CREATE TABLE Classe(Id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, Nom varchar(50) NOT NULL, ecole int NOT NULL, FOREIGN KEY(ecole) REFERENCES ecole(Id), niveau int NOT NULL, FOREIGN KEY(niveau) REFERENCES niveau(Id),annee_scolaire int NOT NULL, FOREIGN KEY(annee_scolaire) REFERENCES AnneeScolaire(Id));
...
INSERT INTO Inscription(classe, eleve ) VALUES(1, 2);
